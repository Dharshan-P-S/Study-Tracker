...
const AboutPage = () => {
  return (
    <div className="bg-slate-50 dark:bg-slate-900">
      ...
      <footer className="text-center py-16 sm:py-20">
        <Link to="/register" className="bg-blue-600 text-white font-semibold py-4 px-8 text-lg rounded-lg hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 transition-transform hover:scale-105">
          Get Started Now
        </Link>
      </footer>
    </div>
